...
function GuestWhatsAppUnifiedControlInner({
  guestId,
  phone,
  source,
  members,
  ...
  const wrapClass =
    variant === 'mob'
      ? 'guest-wa-unified guest-wa-unified--mob'
      : 'guest-wa-unified guest-wa-unified--desk'
    ...
    <div className={wrapClass} title={title} dir="rtl">
      ...
      >
        {sending ? (
          ...
          <IcoWhatsApp className="guest-wa-unified__ico" />
        )}
      </button>
    </div>
  )
...
export const GuestWhatsAppUnifiedControl = memo(GuestWhatsAppUnifiedControlInner)
